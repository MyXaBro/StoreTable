            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-2 mb-3">
                        <a href="{{ route('admin.department.create') }}" class="btn btn-block btn-primary">Добавить</a>
                    </div>
                </div>
                <div class="col-10">
                    <div class="card">
                            ...
                            <table class="table table-hover text-nowrap">
                                ...
                                @foreach($departments as $department)
                                    <tr>
                                        ...
                                        <td><a href="{{route('admin.department.show', $department->id)}}"><i
                                                    class="fa-regular fa-eye"></i></a></td>
                                        <td><a href="{{route('admin.department.edit', $department->id)}}"
